...
export default function CreateCommunityPage() {
  ...
  return (
    <div className="flex-1 w-full bg-white flex flex-col min-h-screen">
      ...
      <div className="px-4 pb-24 max-w-lg md:max-w-4xl mx-auto w-full flex flex-col gap-6 mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-start">
          ...
          {/* Guidelines/Tips Card for Desktop View */}
          <div className="hidden md:flex md:col-span-2 flex-col gap-5">
            <div className="bg-[#FFFBEB] border-2 border-[#0B1E36] rounded-2xl p-5 shadow-[4px_4px_0px_0px_#0B1E36] flex flex-col gap-4">
              ...
              <ul className="text-[11px] font-semibold text-slate-700 space-y-3 leading-relaxed">
